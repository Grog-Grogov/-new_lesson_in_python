...
'''''
list_3 = [1, 2, 2, 25, 25, 45, 232, 444, 676, 11, 11, 23, 23]
'''list_3_1 = (x for x in list_3 if 10 <= x <= 99)
for a in list_3_1:
        print('элементы состоящие только из двухзначных элементов', a)
        '''
#if list_3_1[0] == list_3_1[1] or list_3_1[0] == list_3_1[1] or list_3_1[0] == list_3_1[1]:
 #   print('Два числа стоят рядом равны')
